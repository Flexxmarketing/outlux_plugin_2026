...
if ( ! class_exists( __NAMESPACE__ . '\Flexx_VC_Lifestyle_Gallery' ) ) {

    class Flexx_VC_Lifestyle_Gallery extends Flexx_VC_Element_Template {
        ...
        function shortcode_name(): string {
            return 'flexx-lifestyle-gallery';
        }
        ...
        public function vc_map_shortcode() {
            ...
            vc_map( array(
                "name"                    => "Lifestyle gallerij",
                "base"                    => $this->shortcode_name(),
                "class"                   => "flexx-custom-vc-item",
                "description"             => "Hiermee kun je een lifestyle gallery maken.",
        ...
        public function register_shortcode( $atts, $content = null ) {
            ...
            foreach ( $images as $image ) {
                $images_html .= '
                    <div class="image-wrapper' . ( $count > 0 ? ' parallax-img' : '' ) . '" data-parallax-speed="' . ( $count * 35 ) . '">
            ...
            $html .= '
				<div class="lifestyle-gallery wpb_content_element">
					' . $images_html . '
				</div>
			';
    ...
    new Flexx_VC_Lifestyle_Gallery();
}
